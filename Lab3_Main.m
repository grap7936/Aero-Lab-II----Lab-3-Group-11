...
% be evaluated.
% Task 4: Using the number of panels from task 2, calculate and plot the sectional coefficient of lift, cl, versus angle
% of attack for NACA 0012, NACA 2412, NACA 4412 airfoils
...
%% Task 2 -- 
% Define test variables NACA 0012:
i = 1;
m = 0/100;
p = 0/10;
t = 12/100;
