...
% Output table comparing zero lift angle of attack for each case
...
% NACA 0018 Airfoil -- Note experimental data does not exist for this configuration
Results_Table = table( ...
...
% Output table comparing lift curve slope for each case

% NACA 0006 Airfoil
Results_Table = table( ...
    slope_vort_0006, slope_thin_0006, AoA_exp0006(1), ...
    'VariableNames', {'Vortex_Panel_Method', 'Thin_Airfoil_Theory', 'Experimental_Data'});
disp(Results_Table)

% NACA 0012 Airfoil
Results_Table = table( ...
    slope_vort_0012, slope_thin_0012, AoA_exp0012(1), ...
    'VariableNames', {'Vortex_Panel_Method', 'Thin_Airfoil_Theory', 'Experimental_Data'});
disp(Results_Table)
...
p_thin = polyfit(alpha_rad, cl_thin, 1); % ensure both alpha inputs and cl_thin inputs have units of radians
slope_thin = p_thin(1);

p_vort = polyfit(alpha_rad, CL_vort,1);  % ensure both alpha inputs and cl_thin inputs have units of radians
slope_vort = p_vort(1);
